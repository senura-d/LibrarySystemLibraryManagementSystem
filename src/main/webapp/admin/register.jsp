...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Poppins', sans-serif; }
        ...
        .container {
            width: 1100px;
            height: 700px; /* Slightly taller for extra inputs */
        ...
        /* --- LEFT SIDE: ABSTRACT ART (Swapped to Left) --- */
        .art-section {
            flex: 1;
            /* Teal to Blue Gradient for a "Fresh Start" feel */
        ...
        /* Focus color matches the Teal/Blue gradient */
